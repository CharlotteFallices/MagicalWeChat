...
var __getWebGLContext__ = function(origin_ctx){
            ...
            if(argc == 6){
                ...
                if (i==null) {
                    ...
                    if (ArrayBuffer.isView(i)|| Array.isArray(i)) {
                        commonstring = commonstring  + ';27,9,' + a + ',' + b + ',' + c + ',' + d + ',' + e + ',' + f + ',' + g + ',' + h + ',' + i.length + ',14,' + i;
                    }
                    else {
    ...
    texSubImage2D: function (a, b, c, d, e, f, g, h, i) {
        ...
        if(argc == 7){
            ...
            if (i==null) {
                ...
                if (ArrayBuffer.isView(i)|| Array.isArray(i)) {
                    commonstring = commonstring  + ';81,9,' + a + ',' + b + ',' + c + ',' + d + ',' + e + ',' + f + ',' + g + ',' + h + ',' + i.length + ',14,' + i;
                }
                else {
                    var v = new Uint32Array(i);
    ...
    validateProgram: function (program) {
        checkContextChange(this.ctxid, 1);
        commonstring = commonstring  + ';125,1,' + program;
    },
